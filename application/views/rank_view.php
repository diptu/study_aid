  			...
  			<div class="col-md-12">
                 ...
                 <table style="width:100%" border="1">
    							  <tr >
    								...
    								<th><li><a  class="btn-theme btn-small" data-filter=".webdesign">  Full Name</a></li></th>

    								<th><li><a  class="btn-theme btn-small" data-filter=".webdesign">Email ID </a></li></th>
    								<th><li><a  class="btn-theme btn-small" data-filter=".webdesign">Gender</a></li></th>
